I18N.register('es', {
  ...
  phrases: {
    ...
    'Cảm ơn bạn nhiều.': {
      t: 'Muchas gracias.', caption: 'Agradecer',
    ...
    'Tôi tên là Nam.': {
      t: 'Me llamo Nam.', caption: 'Presentarse',
    ...
    'Bạn khỏe không?': {
      t: '¿Cómo estás?', caption: 'Preguntar cómo está alguien',
    ...
    'Tôi là người Nhật.': {
      t: 'Soy japonés.', caption: 'Nacionalidad',
    ...
    'Rất vui được gặp bạn.': {
      t: 'Encantado de conocerte.', caption: 'Primer encuentro',
    ...
    'Cho tôi một ly cà phê sữa đá.': {
      t: 'Un café con leche con hielo, por favor.', caption: 'Pedir en la cafetería',
    ...
    'Cái này giá bao nhiêu?': {
      t: '¿Cuánto cuesta esto?', caption: 'De compras',
    ...
    'Tôi không hiểu.': {
      t: 'No entiendo.', caption: 'Pedir aclaración',
    ...
    'Xin lỗi, nhà vệ sinh ở đâu?': {
      t: 'Perdón, ¿dónde está el baño?', caption: 'Preguntar por un lugar',
    ...
    'Tôi muốn học tiếng Việt.': {
      t: 'Quiero aprender vietnamita.', caption: 'Ganas de aprender',
    ...
    'Hôm nay trời đẹp quá!': {
      t: '¡Hoy hace muy buen tiempo!', caption: 'Hablar del tiempo',
    ...
    'Bạn nói tiếng Anh được không?': {
      t: '¿Hablas inglés?', caption: 'Comprobar algo',
    ...
    'Tôi bị lạc đường.': {
      t: 'Me he perdido.', caption: 'Problemas',
    ...
    'Làm ơn nói chậm hơn.': {
      t: 'Habla más despacio, por favor.', caption: 'Pedir algo',
    ...
    'Tôi sống ở Hà Nội.': {
      t: 'Vivo en Hanói.', caption: 'Dónde vives',
    ...
    'Ngày mai tôi đi làm.': {
      t: 'Mañana voy a trabajar.', caption: 'Planes',
    ...
    'Chúc ngủ ngon!': {
      t: '¡Buenas noches!', caption: 'Antes de dormir',
