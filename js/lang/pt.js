I18N.register('pt', {
  ...
  phrases: {
    ...
    'Cảm ơn bạn nhiều.': {
      t: 'Muito obrigado.', caption: 'Agradecer',
    ...
    'Tôi tên là Nam.': {
      t: 'Meu nome é Nam.', caption: 'Apresentar-se',
    ...
    'Bạn khỏe không?': {
      t: 'Como vai?', caption: 'Perguntar como alguém está',
    ...
    'Tôi là người Nhật.': {
      t: 'Eu sou japonês.', caption: 'Nacionalidade',
    ...
    'Rất vui được gặp bạn.': {
      t: 'Prazer em conhecer você.', caption: 'Primeiro encontro',
    ...
    'Cho tôi một ly cà phê sữa đá.': {
      t: 'Um café com leite gelado, por favor.', caption: 'Pedir no café',
    ...
    'Cái này giá bao nhiêu?': {
      t: 'Quanto custa isto?', caption: 'Fazendo compras',
    ...
    'Tôi không hiểu.': {
      t: 'Não entendo.', caption: 'Pedir para repetir',
    ...
    'Xin lỗi, nhà vệ sinh ở đâu?': {
      t: 'Com licença, onde fica o banheiro?', caption: 'Perguntar por um lugar',
    ...
    'Tôi muốn học tiếng Việt.': {
      t: 'Quero aprender vietnamita.', caption: 'Vontade de aprender',
    ...
    'Hôm nay trời đẹp quá!': {
      t: 'Hoje o tempo está ótimo!', caption: 'Falar do tempo',
    ...
    'Bạn nói tiếng Anh được không?': {
      t: 'Você fala inglês?', caption: 'Verificar algo',
    ...
    'Tôi bị lạc đường.': {
      t: 'Eu me perdi.', caption: 'Problemas',
    ...
    'Làm ơn nói chậm hơn.': {
      t: 'Por favor, fale mais devagar.', caption: 'Fazer um pedido',
    ...
    'Tôi sống ở Hà Nội.': {
      t: 'Eu moro em Hanói.', caption: 'Onde você mora',
    ...
    'Ngày mai tôi đi làm.': {
      t: 'Amanhã eu vou trabalhar.', caption: 'Planos',
    ...
    'Chúc ngủ ngon!': {
      t: 'Boa noite!', caption: 'Antes de dormir',
