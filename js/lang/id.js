I18N.register('id', {
  ...
  phrases: {
    ...
    'Cảm ơn bạn nhiều.': {
      t: 'Terima kasih banyak.', caption: 'Berterima kasih',
    ...
    'Tôi tên là Nam.': {
      t: 'Nama saya Nam.', caption: 'Memperkenalkan diri',
    ...
    'Bạn khỏe không?': {
      t: 'Apa kabar?', caption: 'Menanyakan kabar',
    ...
    'Tôi là người Nhật.': {
      t: 'Saya orang Jepang.', caption: 'Kewarganegaraan',
    ...
    'Rất vui được gặp bạn.': {
      t: 'Senang bertemu dengan Anda.', caption: 'Pertemuan pertama',
    ...
    'Cho tôi một ly cà phê sữa đá.': {
      t: 'Tolong satu kopi susu dingin.', caption: 'Memesan di kafe',
    ...
    'Cái này giá bao nhiêu?': {
      t: 'Ini harganya berapa?', caption: 'Berbelanja',
    ...
    'Tôi không hiểu.': {
      t: 'Saya tidak mengerti.', caption: 'Meminta pengulangan',
    ...
    'Xin lỗi, nhà vệ sinh ở đâu?': {
      t: 'Permisi, toiletnya di mana?', caption: 'Menanyakan tempat',
    ...
    'Món này rất ngon.': {
      t: 'Masakan ini enak sekali.', caption: 'Makan',
    ...
    'Hẹn gặp lại nhé!': {
      t: 'Sampai jumpa lagi, ya!', caption: 'Berpamitan',
    ...
    'Tôi muốn học tiếng Việt.': {
      t: 'Saya ingin belajar bahasa Vietnam.', caption: 'Semangat belajar',
    ...
    'Hôm nay trời đẹp quá!': {
      t: 'Hari ini cuacanya bagus sekali!', caption: 'Membicarakan cuaca',
    ...
    'Bạn nói tiếng Anh được không?': {
      t: 'Bisakah Anda berbahasa Inggris?', caption: 'Memastikan',
    ...
    'Tôi bị lạc đường.': {
      t: 'Saya tersesat.', caption: 'Masalah',
    ...
    'Làm ơn nói chậm hơn.': {
      t: 'Tolong bicara lebih pelan.', caption: 'Meminta tolong',
    ...
    'Tôi sống ở Hà Nội.': {
      t: 'Saya tinggal di Hanoi.', caption: 'Tempat tinggal',
    ...
    'Ngày mai tôi đi làm.': {
      t: 'Besok saya pergi bekerja.', caption: 'Rencana',
    ...
    'Chúc ngủ ngon!': {
      t: 'Selamat malam!', caption: 'Sebelum tidur',
