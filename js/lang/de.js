I18N.register('de', {
  ...
  phrases: {
    ...
    'Tôi tên là Nam.': {
      t: 'Ich heiße Nam.', caption: 'Sich vorstellen',
    ...
    'Bạn khỏe không?': {
      t: 'Wie geht es dir?', caption: 'Nach dem Befinden fragen',
    ...
    'Tôi là người Nhật.': {
      t: 'Ich bin Japaner.', caption: 'Nationalität',
    ...
    'Rất vui được gặp bạn.': {
      t: 'Schön, dich kennenzulernen.', caption: 'Erstes Treffen',
    ...
    'Cho tôi một ly cà phê sữa đá.': {
      t: 'Einen Eiskaffee mit Milch, bitte.', caption: 'Im Café bestellen',
    ...
    'Cái này giá bao nhiêu?': {
      t: 'Was kostet das?', caption: 'Einkaufen',
    ...
    'Tôi không hiểu.': {
      t: 'Ich verstehe nicht.', caption: 'Nachfragen',
    ...
    'Xin lỗi, nhà vệ sinh ở đâu?': {
      t: 'Entschuldigung, wo ist die Toilette?', caption: 'Nach einem Ort fragen',
    ...
    'Tôi muốn học tiếng Việt.': {
      t: 'Ich möchte Vietnamesisch lernen.', caption: 'Lernwunsch',
    ...
    'Hôm nay trời đẹp quá!': {
      t: 'Heute ist das Wetter herrlich!', caption: 'Übers Wetter reden',
    ...
    'Bạn nói tiếng Anh được không?': {
      t: 'Sprichst du Englisch?', caption: 'Nachfragen',
    ...
    'Tôi bị lạc đường.': {
      t: 'Ich habe mich verlaufen.', caption: 'Probleme',
    ...
    'Làm ơn nói chậm hơn.': {
      t: 'Sprich bitte langsamer.', caption: 'Eine Bitte äußern',
    ...
    'Tôi sống ở Hà Nội.': {
      t: 'Ich wohne in Hanoi.', caption: 'Wohnort',
    ...
    'Ngày mai tôi đi làm.': {
      t: 'Morgen gehe ich zur Arbeit.', caption: 'Pläne',
    ...
    'Chúc ngủ ngon!': {
      t: 'Gute Nacht!', caption: 'Vor dem Schlafen',
